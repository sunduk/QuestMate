...
const MaskingTape: React.FC = () => {
  return (
    <div className="fixed top-9 left-0 right-0 z-60 w-full h-16 flex justify-center pointer-events-none tape-reveal">
      <div className="relative w-full max-w-screen-md flex justify-center" style={{ transform: "rotate(-5deg)" }}>
        <img 
          src="/masking_tape.png" 
          alt="masking tape" 
          className="w-100 object-contain opacity-75" 
        />
        ...
        <style>{`
          ...
          .tape-reveal {
            animation: tapeApply 5000ms ease-out forwards;
          }
        `}</style>
      </div>
    </div>
